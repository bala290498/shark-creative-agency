...
const CurvedLoop: FC<CurvedLoopProps> = ({
  ...
  const pathD = useMemo(() => {
    ...
    return curveAmount === 0 
      ? `M-100,${yPos} L1540,${yPos}`
      : `M-100,${yPos} Q500,${yPos + curveAmount} 1540,${yPos}`
  }, [curveAmount])
  ...
  return (
    <div
      ...
      style={{ 
        ...
        cursor: cursorStyle,
        backgroundColor: interactive ? '#ff6b35' : 'transparent',
    ...
    >
      ...
      >
        <text ref={measureRef} xmlSpace="preserve" dominantBaseline="middle" style={{ visibility: 'hidden', opacity: 0, pointerEvents: 'none' }}>
          {text}
        </text>
        <defs>
