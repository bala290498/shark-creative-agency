  ...
  const timelineData = [
    {
      ...
      content: (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white border border-tiger-orange/30 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
          ...
          <div className="md:col-span-3 bg-white border border-tiger-orange/30 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
    ...
    },
    {
      ...
      content: (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="md:col-span-2 bg-white border border-tiger-orange/30 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="md:col-span-3 bg-white border border-tiger-orange/30 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-4">
              <div className="bg-gray-50 border border-tiger-orange/30 rounded-lg p-4 text-center">
